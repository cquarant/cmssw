...
_phase2_timing_extraCommands = cms.PSet( # using PSet in order to customize with Modifier
    ...
    value = cms.vstring( 'keep *_mix_FTLBarrel_*','keep *_mix_FTLBarrelSoA_*','keep *_mix_FTLEndcap_*','keep *_mix_InitialVertices_*', 'keep *_mtdRecoClusterToSimLayerClusterAssociation_*_*', 'keep *_mtdSimLayerClusterToTPAssociation_*_*')
)
