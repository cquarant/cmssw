...
// #include "SimFastTiming/FastTimingCommon/interface/MTDDigitizerSoA.h"
...
typedef mtd_digitizer::MTDDigitizer<BTLDigitizerTraitsSoA> BTLDigitizerSoA;
...
DEFINE_EDM_PLUGIN(MTDDigitizerFactory, BTLDigitizerSoA, "BTLDigitizerSoA");
